    ...
    <section id="about" className="AboutSection" ref={ref}>
      ...
      <div className="AboutContent">
        <div className={`AboutText ${isVisible ? 'visible' : ''}`}>
          ...
          <p class="paragraph">My journey from practicing law in Brazil to pursuing a career in web and software development in Canada shows my adaptability and strong passion for solving problems. I'm excited by the creative potential of technology and the ability to build solutions that make a difference.</p>
          <p class="paragraph">Outside of my studies, I'm always learning. I find inspiration and knowledge in games, online courses, and videos – always seeking new challenges to grow. This dedication reflects my belief that success in the rapidly changing world of technology requires constant improvement.</p>
          <p class="paragraph">My goal is to work within a collaborative team where I can contribute my creative thinking and technical abilities. I'm eager to take on projects that drive innovation, whether it's building beautiful web interfaces or developing powerful backend systems. I'm most excited about the opportunity to keep learning and expanding my skills in the years to come.</p>
        </div>
